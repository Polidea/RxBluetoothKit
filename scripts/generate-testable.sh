...
testable_pattern="s/\b(Peripheral|BluetoothManager|Service|Characteristic|Descriptor|BluetoothError|ScannedPeripheral|ScanOperation|RestoredState|PeripheralDelegateWrapperProvider)\b/_&/g"
# remove all public's
